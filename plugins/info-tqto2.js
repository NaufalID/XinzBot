 ...
 *Jawaban:* ${pickRandom(['Ya','Mungkin iya','Mungkin','Mungkin tidak','Tidak','Tidak mungkin'])} 
 ...
 handler.help = ['ɴᴜʀᴜᴛᴏᴍᴏ','ᴀᴅɪᴡᴀᴊsʜɪɴɢ','ʀᴇɴᴅʏᴄʀᴀғᴛ','ɪʙɴᴜ ɴʀ','ʙᴀᴋᴀ ʙᴏᴛᴢ', 'ᴀʀɪғғʙ25','ᴀᴛᴇɴᴀʙᴏᴛ','ʙᴀᴋᴀ ᴛᴇᴀᴍ','ꜰNaufal Muflih','ꜰᴏᴋᴜꜱ ɪᴅ','ᴋᴀɴɴᴀ','Hanifah','ᴀᴍɪʀᴜʟ','ɴᴜʀᴜᴛᴏᴍᴏ','ʙᴏᴄʜɪʟɢᴀᴍɪɴɢ','ᴀᴅɪᴡᴀᴊꜱʜɪɴɢ'] 
 handler.tags = ['thnks'] 
